...
- Single-page can have multiple routes “Client-side routing”
    - routes don’t point to server, just updated by javascript
...
- cache can be invalidated with certain rules
- static site
- dynamic server data
